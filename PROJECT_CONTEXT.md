...
func _init(nName="", nCost : int = 1, nType = CardEnum.CardType.SPELL, nAbilities:Dictionary[int, CardAbilityInfo]={}):
	name = nName
	cost = nCost
	type = nType
...
func resolve() -> void: 
	...
	var cursor : Cursor = caster.weapon.cursor
...
[node name="Weapon" parent="." instance=ExtResource("5_q3f8m")]
...
```ini
[gd_scene load_steps=4 format=3 uid="uid://bfxyiv3p7jta5"]
...
[node name="WeaponHud" parent="Player/Weapon" index="0"]
visible = false
...
[node name="RichTextLabel" type="RichTextLabel" parent="WeaponHud"]
anchors_preset = 3
anchor_left = 1.0
anchor_top = 1.0
anchor_right = 1.0
